...
![Version: 0.4.3](https://img.shields.io/badge/Version-0.4.3-informational?style=flat-square) ![AppVersion: 24.4](https://img.shields.io/badge/AppVersion-24.4-informational?style=flat-square)
...
| answerbankAgentstore.additionalVolumeMounts | list | `[{"mountPath":"/answerbank-agentstore/poststart_scripts/002_startup_tasks.sh","name":"config-map","subPath":"answerbank-agentstore-poststart.sh"}]` | Additional PodSpec Volume (see https://kubernetes.io/docs/reference/kubernetes-api/workload-resources/pod-v1/#volumes) N.B. AgentStore creates required databases on startup via poststart script mount |
