...
![Version: 0.9.0](https://img.shields.io/badge/Version-0.9.0-informational?style=flat-square) ![AppVersion: 26.1](https://img.shields.io/badge/AppVersion-26.1-informational?style=flat-square)
...
> Full documentation for OmniGroupServer available from <https://www.microfocus.com/documentation/idol/knowledge-discovery-26.1/OmniGroupServer_26.1_Documentation/Help/>
...
1. The Prestart script will detect any [External Configuration File Includes](https://www.microfocus.com/documentation/idol/knowledge-discovery-26.1/OmniGroupServer_26.1_Documentation/Help/Content/Configuration/_ACI_Config_Intro.htm#Include-an-Exter)
...
| replicas | int | `1` | number of replica pods for this workload (defaults to 1). |
